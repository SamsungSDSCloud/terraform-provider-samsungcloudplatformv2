...
type License struct {
	LicenseExpiryDate types.String `tfsdk:"license_expiry_date"`
	...
	return map[string]attr.Type{
		...
		"init_config_option": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				...
				"kibana_port":        types.Int32Type,
				"dashboards_port":    types.Int32Type,
		...
		"license": types.ObjectType{
			AttrTypes: map[string]attr.Type{
				"license_expiry_date": types.StringType,
				"license_status":      types.StringType,
