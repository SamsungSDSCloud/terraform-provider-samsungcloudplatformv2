...
// NewIamGroupDataSource is a helper function to simplify the provider implementation.
...
func (d *iamGroupDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_iam_group"
}

// Configure adds the provider configured client to the data source.
func (d *iamGroupDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *iamGroupDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) { // 아직 정의하지 않은 Schema 메서드를 추가한다.
												...
												Attributes: map[string]schema.Attribute{
													"statement": schema.ListNestedAttribute{
														...
														Description: "List of policy statements defining the permissions.\n" +
															"  - example : [{\"sid\": \"Stmt1\", \"effect\": \"Allow\", \"action\": [\"iam:CreateRole\"], ...}]",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
...
func (d *iamGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state iam.GroupDataSourceDetail
	...
	data, err := d.client.GetGroup(ctx, state.Id.ValueString())
	if err != nil {
		resp.Diagnostics.AddError(
