	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			common.ToSnakeCase("VpcPeeringID"): schema.StringAttribute{
				Description: "The identifier of the VPC Peering ID\n" +
			...
			common.ToSnakeCase("VpcPeering"): schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					common.ToSnakeCase("RequesterVpcAccountId"): schema.StringAttribute{
						Description: "The identifier of account that the requester VPC belongs to.\n" +
							"  - example : f1e6c81a2b054582878cb9724dc2ce9f",
						Computed: true,
					},
					...
					common.ToSnakeCase("State"): schema.StringAttribute{
						Description: "The current lifecycle state of the approval.\n" +
