...
var (
	_ datasource.DataSource              = &sqlserverClusterDataSources{}
	_ datasource.DataSourceWithConfigure = &sqlserverClusterDataSources{}
)

func NewSqlserverClusterDataSources() datasource.DataSource {
	return &sqlserverClusterDataSources{}
}

type sqlserverClusterDataSources struct {
	config  *scpsdk.Configuration
	client  *sqlserver.Client
	clients *client.SCPClient
}

func (d *sqlserverClusterDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sqlserver_clusters"
}

func (d *sqlserverClusterDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sqlserverClusterDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sqlserverClusterDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state sqlserver.ClusterDataSource
	...
	for _, clusterElement := range data.Contents {
		clusterState := sqlserver.Cluster{
