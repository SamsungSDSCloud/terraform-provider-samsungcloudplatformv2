...
var (
	_ datasource.DataSource              = &cachestoreClusterDataSources{}
	_ datasource.DataSourceWithConfigure = &cachestoreClusterDataSources{}
)

func NewCachestoreClusterDataSources() datasource.DataSource {
	return &cachestoreClusterDataSources{}
}

type cachestoreClusterDataSources struct {
	config  *scpsdk.Configuration
	client  *cachestore.Client
	clients *client.SCPClient
}

func (d *cachestoreClusterDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cachestore_clusters"
}

func (d *cachestoreClusterDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *cachestoreClusterDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *cachestoreClusterDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state cachestore.ClusterDataSource
	...
	for _, clusterElement := range data.Contents {
		clusterState := cachestore.Cluster{
