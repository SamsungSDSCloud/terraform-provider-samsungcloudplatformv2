...
var (
	_ datasource.DataSource              = &epasClusterDataSource{}
	_ datasource.DataSourceWithConfigure = &epasClusterDataSource{}
)

func NewEpasClusterDataSource() datasource.DataSource {
	return &epasClusterDataSource{}
}

type epasClusterDataSource struct {
	config  *scpsdk.Configuration
	client  *epas.Client
	clients *client.SCPClient
}

func (d *epasClusterDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_epas_cluster"
}

func (d *epasClusterDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *epasClusterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *epasClusterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state epas.ClusterDataSourceDetail
	...
	var initConfigOption = &epas.InitConfigOptionBase{
