...
var (
	_ datasource.DataSource              = &eventstreamsClusterDataSources{}
	_ datasource.DataSourceWithConfigure = &eventstreamsClusterDataSources{}
)

func NewEventstreamsClusterDataSources() datasource.DataSource {
	return &eventstreamsClusterDataSources{}
}

type eventstreamsClusterDataSources struct {
	config  *scpsdk.Configuration
	client  *eventstreams.Client
	clients *client.SCPClient
}

func (d *eventstreamsClusterDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_eventstreams_clusters"
}

func (d *eventstreamsClusterDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *eventstreamsClusterDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *eventstreamsClusterDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state eventstreams.ClusterDataSource
	...
	for _, clusterElement := range data.Contents {
		clusterState := eventstreams.Cluster{
