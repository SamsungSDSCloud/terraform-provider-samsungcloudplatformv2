...
var (
	_ datasource.DataSource              = &mariadbClusterDataSource{}
	_ datasource.DataSourceWithConfigure = &mariadbClusterDataSource{}
)

func NewMariadbClusterDataSource() datasource.DataSource {
	return &mariadbClusterDataSource{}
}

type mariadbClusterDataSource struct {
	config  *scpsdk.Configuration
	client  *mariadb.Client
	clients *client.SCPClient
}

func (d *mariadbClusterDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mariadb_cluster"
}

func (d *mariadbClusterDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *mariadbClusterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *mariadbClusterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state mariadb.ClusterDataSourceDetail
	...
	var mariadbState = mariadb.ClusterDetail{
	...
	mariadbObjectValue, _ := types.ObjectValueFrom(ctx, mariadbState.AttributeTypes(), mariadbState)
	state.ClusterDetail = mariadbObjectValue
