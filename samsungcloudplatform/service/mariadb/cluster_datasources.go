...
var (
	_ datasource.DataSource              = &mariadbClusterDataSources{}
	_ datasource.DataSourceWithConfigure = &mariadbClusterDataSources{}
)

func NewMariadbClusterDataSources() datasource.DataSource {
	return &mariadbClusterDataSources{}
}

type mariadbClusterDataSources struct {
	config  *scpsdk.Configuration
	client  *mariadb.Client
	clients *client.SCPClient
}

func (d *mariadbClusterDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mariadb_clusters"
}

func (d *mariadbClusterDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *mariadbClusterDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *mariadbClusterDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state mariadb.ClusterDataSource
	...
	for _, clusterElement := range data.Contents {
		var clusterState = mariadb.Cluster{
