...
var (
	_ datasource.DataSource              = &searchengineClusterDataSources{}
	_ datasource.DataSourceWithConfigure = &searchengineClusterDataSources{}
)

func NewSearchengineClusterDataSources() datasource.DataSource {
	return &searchengineClusterDataSources{}
}

type searchengineClusterDataSources struct {
	config  *scpsdk.Configuration
	client  *searchengine.Client
	clients *client.SCPClient
}

func (d *searchengineClusterDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_searchengine_clusters"
}

func (d *searchengineClusterDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						common.ToSnakeCase("Id"): schema.StringAttribute{
							Description:         "Identifier of the resource.\n  - example: 433bb9bd2f724f66b04da3a525e23c56",
...
func (d *searchengineClusterDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *searchengineClusterDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state searchengine.ClusterDataSource
	...
	for _, clusterElement := range data.Contents {
		clusterState := searchengine.Cluster{
