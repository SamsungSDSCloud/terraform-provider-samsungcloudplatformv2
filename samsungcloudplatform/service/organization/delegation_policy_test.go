				...
				statement = [
					{
						...
						sid = "test-acc-sid-1"
						principal = {
							scp = ["srn:%s::${samsungcloudplatformv2_organization.org.master_account_id}:::iam:user/${samsungcloudplatformv2_iam_user.delegation_policy_user.user_id}"]
						}
					}
				]
				version = "2024-07-01"
