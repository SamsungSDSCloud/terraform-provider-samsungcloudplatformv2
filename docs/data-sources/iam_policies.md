...
- `page` (Number) Page (between 0 and 10000)
  - example : 0
- `policies` (Attributes List) A list of policy
  - example : [{"id": "pol-1234567890abcdef", "policy_name": "MyPolicy", "policy_type": "USER_DEFINED", ...}] (see [below for nested schema](#nestedatt--policies))
...
- `policy_versions` (Attributes List) List of versions of the policy.
  - example : [{"id": "v-1234567890abcdef", "policy_version_name": "v1", ...}] (see [below for nested schema](#nestedatt--policies--policy_versions))
...
- `policy_document` (Attributes) The policy document containing permission definitions.
  - example : {"version": "2012-10-17", "statement": [{"sid": "Stmt1", "effect": "Allow", ...}]} (see [below for nested schema](#nestedatt--policies--policy_versions--policy_document))
