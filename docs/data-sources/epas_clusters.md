---
page_title: "samsungcloudplatformv2_epas_clusters Data Source - samsungcloudplatformv2"
subcategory: Epas
description: |-
  List of Clusters.
---

# samsungcloudplatformv2_epas_clusters (Data Source)
...
output "clusters" {
  value = data.samsungcloudplatformv2_epas_clusters.clusters
}
