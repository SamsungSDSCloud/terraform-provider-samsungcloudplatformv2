...
var (
	_ datasource.DataSource              = &eventstreamsEngineVersionDataSources{}
	_ datasource.DataSourceWithConfigure = &eventstreamsEngineVersionDataSources{}
)

func NewEventstreamsEngineVersionDataSources() datasource.DataSource {
	return &eventstreamsEngineVersionDataSources{}
}

type eventstreamsEngineVersionDataSources struct {
	config  *scpsdk.Configuration
	client  *eventstreams.Client
	clients *client.SCPClient
}

func (d *eventstreamsEngineVersionDataSources) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_eventstreams_engine_version"
}

func (d *eventstreamsEngineVersionDataSources) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						common.ToSnakeCase("Id"): schema.StringAttribute{
							Description:         "Engine version ID\n  - example: c51ea6c20957496eb97b9d605b0059ab",
...
func (d *eventstreamsEngineVersionDataSources) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *eventstreamsEngineVersionDataSources) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state eventstreams.EngineVersionDataSource
	...
	for _, engineVersionElement := range data.Contents {
		engineVersionState := eventstreams.EngineVersion{
